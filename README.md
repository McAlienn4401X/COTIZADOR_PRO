...
Descarga CotizadorPro.html
Haz doble clic en el archivo → se abre en tu navegador
¡Listo! La app funciona completamente desde ahí.
Opción B — Instalar acceso directo en el Escritorio
🪟 Windows
Descarga CotizadorPro.html en cualquier carpeta (ej: Documentos)
